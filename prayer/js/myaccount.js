...
function validateEmail(sEmail) {
                                    var filter = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
                                                                ...
                                                                $.ajax({
                                                                                                                     type       : "POST",
                                                                                                                     url        : "http://www.kickback.sg/shopper/mobile_app/account",
                                                                       ...
                                                                       if(response.lastvisitcnt==0)
																	 {
																	 $('#Lvst').append('Start shopping to earn cashback');
																	 $('#Csid').append('<div align="center"><a href="shopinglist.html" style="color:#FFFFFF;">Shop Now</a></div>');
																	 }
																	 else
																	 {
																		$('#Lvst').append('Your last three visits');
																		$('#Csid').append('<div align="center"><a href="cashout1.html" style="color:#FFFFFF;;">Cashout</a></div>');
																	 }
                                                                  ...
                                                                  $( document ).on( "pageinit","#shoppinglist",function() {
                                                                         ...
                                                                         $("#recent").click(function () {
                                                                                           $(".radio-drop").slideDown("fast");
                                                                                             ...
                                                                                             $.ajax({
                                                                                                    type       : "POST",
                                                                                                    url        : "http://www.kickback.sg/shopper/mobile_app/merchants",
                                                                                                    contentType: "application/json ",
                                                                                                    beforeSend : function() {ActivityIndicator.show()},
                                                                                                    complete   : function() {ActivityIndicator.hide()},
                                                                ...
                                                                //  alert(userid);
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/like",
                                                                         contentType: "application/json ",
                                                                         beforeSend : function() {ActivityIndicator.show()},
                                                                         complete   : function() {ActivityIndicator.hide()},
                                                                         data       : '{"user_id": '
                                                                ...
                                                                //  alert(userid);
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/unlike",
                                                                         contentType: "application/json ",
                                                                         beforeSend : function() {ActivityIndicator.show()},
                                                                         complete   : function() {ActivityIndicator.hide()},
                                                                         data       : '{"user_id": '
...
$.each(response.merchants, function(k, v) {if(v.fav==""){mySecondDiv=$('<li id="'+v.name+'" class="lishop">'
                                                                         ...
                                                                         +' </div>'
                                                                         +' <div class="col-xs-4 col-sm-5 shop-mdl"><h1>'+ v.name +'</h1>'
                                                                         +' <p style="margin-top: -10px;">'+ v.area_name +'</p>'
                                                                         +' <div id="'+v.name+'" class="shop-icon">'
                                                                         +' <span class="shop-heart si">'
                                                                         +'<i class="fa fa-heart-o"></i>'
                                                                         +' </span>'
                                                                                   ...
                                                                                   $('#detail h2').append(shopper.name);
                                                                                    ...
                                                                                    $('#wamount').text(localStorage.getItem("wamount"));
                                                                                      //$('#merchant_phone').append(shopper.merchant_phone);
                                                                                       ...
                                                                                       $('#detail p:nth-of-type(3)').append(shopper.operating_hour);
																					...
																					$('#detailr p:nth-of-type(1)').append(shopper.remarks);
                                                                  });
...
//                                                                                                           });
                                                                  ...
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/transactionhistory",
                                                                         contentType: "application/json ",
                                                                         beforeSend : function() {ActivityIndicator.show()},
                                                                         complete   : function() {ActivityIndicator.hide()},
                                                                         data       : '{"user_id": '
                                                                        ...
                                                                        // navigator.notification.alert(response.msg, alertDismissed, 'Error', 'OK');
                                                                          $('#translist').append('<span style="color: #000000; background: none; font-weight: normal;">'+response.msg+'</span>');
                                                                         }
                                                                         },
                                                                         error      : function(e) {
                                                                 ...
                                                                 // $(".radio-drop").slideDown("fast");
                                                                  ...
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/cashbackhistory",
                                                                         contentType: "application/json ",
                                                                         beforeSend : function() {ActivityIndicator.show()},
                                                                         complete   : function() {ActivityIndicator.hide()},
                                                                         data       : '{"user_id": '
                                                                         ...
                                                                         //navigator.notification.alert(response.msg, alertDismissed, 'Error', 'OK');
                                                                          $('#cashlist1').append('<span style="color: #000000; background: none; font-weight: normal;">'+response.msg+'</span>');
                                                                         }
                                                                         },
                                                                         error      : function(e) {
                                                                 ...
                                                                 if(tokeen!=""){
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/savetoken",
                                                                         contentType: "application/json ",
                                                                         beforeSend : function() {},
                                                                         complete   : function() {},
