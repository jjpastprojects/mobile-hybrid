                                    ...
                                    var filter = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
                                                                  ...
                                                                  $( document ).on( "pageinit","#register",function() {
                                                                                   ...
                                                                                   $("#registerbutton").click(function ()  {
                                                                                                              ...
                                                                                                              if(passlen < 6) {
                                                                                                                navigator.notification.alert('Your password must have at least 6 characters', alertDismissed, 'Error', 'OK');
                                                                                                            //  alert("Please enter Minimum 6 digit");
																											  ...
																											  var referral_codev =  $('#referral_code').val();
...
//                                                                                                              }
                                                                                                              if(pemail=="" || ppassword=="" || pname==""  || pphone=="" ){
                                                                                                               navigator.notification.alert('Please enter all the fields', alertDismissed, 'Error', 'OK');
                                                                                                              ...
                                                                                                              $.ajax({
                                                                                                                     type       : "POST",
                                                                                                                     url        : "http://www.kickback.sg/shopper/mobile_app/insertCustomer",
																...
																$( document ).on( "pageinit","#login",function() {
                                                                                   ...
                                                                                   $("#loginbutton").click(function () {
                                                                                                           ...
                                                                                                           if (emaill!="") {
                                                                                                                      ...
                                                                                                                      navigator.notification.alert('Please enter your email/phone number', alertDismissed, 'Error', 'OK');
                                                                                                        //   alert('Invalid Email Address');
                                                                                                           ...
                                                                                                           if (password=="") {
                                                                                                            navigator.notification.alert('Please enter a valid password', alertDismissed, 'Error', 'OK');
                                                                                                          // alert('Invalid password');
                                                                                                           ...
                                                                                                           $.ajax({
                                                                                                                  type       : "POST",
                                                                                                                  url        : "http://www.kickback.sg/shopper/mobile_app/login",
                                                                                                                  contentType: "application/json ",
                                                                       ...
                                                                       dataType   : 'json',
                                                                                                      ...
                                                                                                      localStorage.setItem("login","login");
                                                                                                                  ...
                                                                                                                  if(response.msg=="You have not authenticate your account")
                                                                                                                  {
																...
																$( document ).on( "pageinit","#forgot",function() {
                                                                                   FastClick.attach(document.body);
                                                                                   $("#forgotbutton").click(function ()  {
                                                                                                              
                                                                                                             var ffemail =  $('#emailff').val();
                                                                                                              
                                                                                                              //alert(ffemail);
                                                                                                        
                                                                                                            /*if (validateEmail(ffemail)) {
                                                                                                             ...
                                                                                                             navigator.notification.alert('Invalid Email Address', alertDismissed, 'Error', 'OK');
                                                                                                              ...
                                                                                                              if(ffemail==""){
                                                                                                               navigator.notification.alert('Please fill 
																																			fields', alertDismissed, 'Error', 'OK');
                                                                                                              //alert("Please fill all fields");
                                                                                                              e.preventDefault();
                                                                                                              }*/
                                                                                                              ...
                                                                                                              $.ajax({
                                                                                                                     type       : "POST",
                                                                                                                     url        : "http://www.kickback.sg/shopper/mobile_app/shopperforgot",
                                                                                                                     contentType: "application/json ",
                                                                                                                     beforeSend : function() {ActivityIndicator.show()},
                                                                                                                     complete   : function() {ActivityIndicator.hide()},
                                                                                                                     data       : '{"email": "' + ffemail + '"}',
																										  ...
																										  // localStorage.setItem("userid", response.user_id);
                                                                                                                     //localStorage.setItem("email", ffemail);
																													 alert(response.msg);
                      ...
                      FastClick.attach(document.body);    
                         ...
                         $("#authentication").click(function () {
                                                    ...
                                                    $.ajax({
                                                           type       : "POST",
                                                           url        : "http://www.kickback.sg/shopper/mobile_app/authenticate",
                                                           contentType: "application/json",
                         ...
                         $("#resend").click(function () {
                                            ...
                                            $.ajax({
                                                   type       : "POST",
                                                   url        : "http://www.kickback.sg/shopper/mobile_app/resend",
                                                   contentType: "application/json ",
                                                ...
                                                //   alert("Network Error.Try Again");
                                                                 ...
                                                                 // var userid =  localStorage.getItem("email");
                                                                                                                                                   ...
                                                                                                                                                   $.ajax({
                                                                                                                                                          type       : "POST",
                                                                                                                                                          url        : "http://www.kickback.sg/shopper/mobile_app/scracthamount",
                                                                                                                                                          contentType: "application/json ",
                                                                            ...
                                                                            localStorage.setItem("shakeamount", response.amount);
																			
																			$('#amount').append('You have won $'+response.amount);
                                                                  ...
                                                                  $(document).on( "pageinit","#myaccount",function() {
							   												var accountpagenav =  localStorage.getItem("accountpagenav");
                                                                                 ...
                                                                                 $("#nextbutton12").click(function () {
																				  ...
																				  $("#Pbtnp").click(function () {
																											  
																											// localStorage.setItem("Sedit", 1);
																											//var imagee = document.getElementById('largeImage').getAttribute("src");
                                                                                 ...
                                                                                 $.ajax({
                                                                                        type       : "POST",
                                                                                        url        : "http://www.kickback.sg/shopper/mobile_app/myaccount",
                                                                                        contentType: "application/json ",
                                                                                      ...
                                                                                      /*$('#gender').val(response.gender).attr("selected", "selected");
                                                                                       ...
                                                                                       /* $('#genderpp').val(response.gender).attr("selected", true);
																					 $("#genderpp").selectmenu('');
																					 
                                                                                       $("#genderpp").selectmenu('refresh', true);*/

                                                                                        $('#email').val(response.email);
                                                                                        $('#pppemail').val(response.paypal_email);
...
//
                                                                      ...
                                                                      var Sedit
                                                                  function UpdateData(Sedit) {
                                                                  

                                                                  
                                                                  var selectfname =  $('#fnameee').val();
                                                                  if (selectfname=="") {
                                                                   navigator.notification.alert('Please enter a valid name', alertDismissed, 'Error', 'OK');
                                                                 // alert('Invalid name');
                                                                  e.preventDefault();
                                                                  }
																  
																   var pppemail =  $('#pppemail').val();
                                                                  if (pppemail=='') {
                                                                   navigator.notification.alert('Please enter a valid PayPal ID', alertDismissed, 'Error', 'OK');
                                                                 // alert('Invalid name');
                                                                  e.preventDefault();
                                                                  }
                                                                  ...
                                                                  if (selectdob=="") {
                                                                   navigator.notification.alert('Please enter a valid date of birth', alertDismissed, 'Error', 'OK');
                                                                  // alert('Invalid Date of Birth');
                                                                  e.preventDefault();
                                                                  }
                                                                 /* var selectgender =  $('#genderpp').val();
                                            ...
                                            $.ajax({
                                                   type       : "POST",
                                                   url        : "http://www.kickback.sg/shopper/mobile_app/updatemyaccount",
                                                   contentType: "application/json ",
                                                   
                                                   beforeSend : function() {ActivityIndicator.show()},
                                                   complete   : function() {ActivityIndicator.hide()},
                                                   data       : '{"user_id": "' + userid + '","fname": "' + selectfname + '","paypal_email": "' + pppemail + '","dob": "' + selectdob + '"}',
                                                   dataType   : 'json',
                                                   success    : function(response) {
                                                   var accountpagenav =  localStorage.getItem("accountpagenav");
												   
                                                                  if(accountpagenav!=""){
                                                                // var Sedit =  localStorage.getItem("Sedit");
																 if(Sedit)
																 $.mobile.changePage( "account.html", { transition: "pop"} );
																 else
                                                                  $.mobile.changePage( "myaccount.html", { transition: "pop"} );
                                                ...
                                                //   alert("Network Error.Try Again");
                                                                ...
                                                                var  destinationType=navigator.camera.DestinationType;
                                                                  ...
                                                                  $.ajax({
                                                                         type       : "POST",
                                                                         url        : "http://www.kickback.sg/shopper/mobile_app/redeemamount",
                                                                         contentType: "application/json ",
                                                                         ...
                                                                         success    : function(response) {
                                                                         console.error(JSON.stringify(response));
																		 localStorage.setItem("accountpagenav", 1);
                                                                         $.mobile.changePage( "myaccount.html", { transition: "pop"} );
                                                                  ...
                                                                  $(document).on( "pageinit","#changepassword",function() {
                                                                                 ...
                                                                                 $("#changebtn").click(function () {
                                                                                                      ...
                                                                                                      ;
                                                                                                       ...
                                                                                                       if(old < 1) {
                                                                                                       navigator.notification.alert('Please enter your password', alertDismissed, 'Error', 'OK');
                                                                                                      ...
                                                                                                      e.preventDefault();
                                                                                                       ...
                                                                                                       if(newpassword != confirmpassword) {
                                                                                                        navigator.notification.alert('Password does not match the confirm password', alertDismissed, 'Error', 'OK');
                                                                  ...
                                                                  $( document ).on( "pageinit","#qrcode",function() {
                                                                                   ...
                                                                                   $.ajax({
                                                                                          type       : "POST",
                                                                                          url        : "http://www.kickback.sg/shopper/mobile_app/paynow",
                                                                                          contentType: "application/json ",
                                                                                          beforeSend : function() {ActivityIndicator.show()},
                                                                                          complete   : function() {ActivityIndicator.hide()},
                                                                                          data       : '{"user_id": '
                                                                  ...
                                                                  $( document ).on( "pageinit","#cashout1",function() {
                                                                                   ...
                                                                                   $("#cashbackbtn").click(function () {
                                                                                                           ...
                                                                                                           $.ajax({
                                                                                                                  type       : "POST",
                                                                                                                  url        : "http://www.kickback.sg/shopper/mobile_app/cashout",
                                                                                                                  contentType: "application/json ",
                                                                                                                  beforeSend : function() {ActivityIndicator.show()},
                                                                                                                  complete   : function() {ActivityIndicator.hide()},
                                                                  ...
                                                                  $( document ).on( "pageinit","#cashout2",function() {
                                                                                   ...
                                                                                   $("#cashbackotp").click(function () {
                                                                                                           ...
                                                                                                           $.ajax({
                                                                                                                  type       : "POST",
                                                                                                                  url        : "http://www.kickback.sg/shopper/mobile_app/cashout_confirm",
                                                                                                                  contentType: "application/json ",
                                                                                                                  beforeSend : function() {ActivityIndicator.show()},
                                                                                                                  complete   : function() {ActivityIndicator.hide()},
                                                                                               ...
                                                                                               // alert(response.msg);
                                                                                                    ...
                                                                                                    $.mobile.changePage( "myaccount.html", { transition: "pop"} );                
                                                                                                                 ...
                                                                                                                 // alert(response.msg);
                                                                                                                  ...
                                                                                                                  //console.error("error");
                                                                                                                     navigator.notification.alert('The operation could not be completed, please try again', alertDismissed, 'Success', 'OK');
                                                                                                                  }
                                                                                                                  });
                                                                                   ...
                                                                                   $("#cashbackotpresend").click(function () {
                                                                                                           ...
                                                                                                           $.ajax({
                                                                                                                  type       : "POST",
                                                                                                                  url        : "http://www.kickback.sg/shopper/mobile_app/resend_otp",
                                                                                                                  contentType: "application/json ",
                                                                                                                  beforeSend : function() {ActivityIndicator.show()},
                                                                                                                  complete   : function() {ActivityIndicator.hide()},
                                                                                                                  data       : '{"user_id": "' + userid + '"}',
